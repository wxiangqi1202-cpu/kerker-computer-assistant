...
要求：
  - 用第三人称，以"用户"开头，语义完整不依赖上下文
  - importance 评分：强烈偏好/个人事实=7-9，日常习惯/轻微情绪=5-6，模糊信息=3-4
  - importance < 4 的直接丢弃不输出
  - 如果消息中没有可提取的个人信息，直接输出空数组 []
